...
export async function GET(
  ...
  const c = theme === 'dark'
    ? { bg: '#171717', fg: '#ffffff', sub: '#a3a3a3', ring: '#2a2a2a', mark: '#ffffff', markFg: '#171717' }
    : { bg: '#ffffff', fg: '#171717', sub: '#737373', ring: '#e5e5e5', mark: '#171717', markFg: '#ffffff' }
  ...
  <circle cx="34" cy="32" r="17" fill="${c.mark}"/>
  <text x="34" y="38" text-anchor="middle" font-family="Georgia, 'Times New Roman', serif" font-size="17" font-weight="700" fill="${c.markFg}">N</text>
  <text x="64" y="27" font-family="-apple-system, Segoe UI, Roboto, Helvetica, Arial, sans-serif" font-size="11" font-weight="600" letter-spacing="0.4" fill="${c.sub}">${label.toUpperCase()}</text>
  <text x="64" y="46" font-family="Georgia, 'Times New Roman', serif" font-size="18" font-weight="700" fill="${c.fg}">${brand}</text>
</svg>`
